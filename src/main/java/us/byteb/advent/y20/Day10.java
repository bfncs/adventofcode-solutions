...
public class Day10 {
  ...
  public static void main(String[] args) {
    final List<Long> input = parseInput(readFileFromResources("y20/day10.txt"));
  ...
  static BigInteger countDistinctValidArrangementsRec(
    ...
    return items.contains(items.get(0) + 1)
        ...
        : countDistinctValidArrangementsRec(
            remainingInput, 0, combos.multiply(BigInteger.valueOf(TRIBONACCI_SEQUENCE.get(streak))));
  }
}
