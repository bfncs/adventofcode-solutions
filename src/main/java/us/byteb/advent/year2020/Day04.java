...
public class Day04 {
  ...
  public static void main(String[] args) {
    final List<Passport> parsedInput = parseInput(readFileFromResources("year2020/day04.txt"));
    System.out.println("Part 1: " + filterValid(parsedInput, Day04::hasRequiredFields).size());
    System.out.println("Part 2: " + filterValid(parsedInput, Day04::hasValidFields).size());
  }
