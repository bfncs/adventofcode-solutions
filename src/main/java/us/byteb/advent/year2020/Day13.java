...
import us.byteb.advent.year2020.Day13.BusIdCandidate.BusId;
import us.byteb.advent.year2020.Day13.BusIdCandidate.OutOfServiceBusId;

public class Day13 {

  public static void main(String[] args) {
    final Notes notes = parseInput(readFileFromResources("year2020/day13.txt"));
