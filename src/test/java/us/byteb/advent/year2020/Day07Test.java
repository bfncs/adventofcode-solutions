...
class Day07Test {
  ...
  void parseExample() {
    ...
    final Map<String, Map<String, Integer>> parsedRules = Day07.parseRules(input);
  ...
  void solveExamplePart1() {
    assertEquals(
        ...
        Day07.findAllPossibleContainingBagColor("shiny gold", RULES));
  }

  @Test
  void solveExamplePart2() {
    assertEquals(32, Day07.findNumBags("shiny gold", RULES));
